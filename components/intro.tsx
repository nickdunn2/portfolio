    ...
    <section ref={ref} id="home" className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        ...
        <a
          href="/Resume.pdf"
          download
          className="group flex items-center bg-gray-50 px-7 py-3 gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack"
        >
        ...
        <a
          ...
          target="_blank"
          className="flex items-center bg-gray-50 text-gray-700 p-4 gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack"
        >
          <BsLinkedin/>
        </a>
        <a
